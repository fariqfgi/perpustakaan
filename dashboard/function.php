<?php  
	...
	function tambahbuku($databuku) {
		...
		$query = "INSERT INTO tblbuku VALUES (NULL,'$kode','$judul','$penerbit','$jumlah','$jenis')";
	...
	function registrasi($datauser) {
		...
		mysqli_query($conn, "INSERT INTO tbluser VALUES(NULL,'$nama','$username','$passencrypted','$email','User','$pict','$jenis_kelamin', 'Pending')");
		return mysqli_affected_rows($conn); 
	}
	...
	function pinjambuku($databuku) {
		...
		$exe = mysqli_query($conn, "INSERT INTO tblpinjam VALUES(NULL,'$kode','$judul','$nama','$tanggal','Dibaca')");
		return mysqli_affected_rows($conn);
	}
	...
	function kembalikanbuku($databuku) {
		...
		$exe = mysqli_query($conn, "INSERT INTO tblrequestkembali VALUES 
							(NULL,'$kode','$judul','$nama','$tanggalpinjam','$tanggalkembalikan')");
